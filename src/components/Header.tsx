    ...
    <header className="relative z-[999]">
      <m.div
        className={cn(
          ...
          ' backdrop-blur dark:border-black/40 dark:bg-gray-950 dark:bg-opacity-75 sm:h-[3.25rem] sm:w-[39rem] sm:rounded-full',
        )}
        initial={{ y: -100, x: '-50%', opacity: 0 }}
        animate={{ y: 0, x: '-50%', opacity: 1 }}></m.div>

      <nav className="fixed left-1/2 top-[0.80rem] flex h-12 -translate-x-1/2 py-2 sm:top-[0.30rem] sm:h-[initial] sm:py-0">
